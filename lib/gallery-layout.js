...
export function layoutGallery(pieces) {
  return pieces.map((piece, i) => {
    // Determine if it spans columns
    const isHero = piece.layout === "hero" || piece.layout === "hero-center" || piece.destacado;
    
    // Explicit editorial layout
    const scaleClass = piece.layout || "contained";
